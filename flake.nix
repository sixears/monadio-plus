{
  ...
  inputs = {
    ...
    containers-plus.url = "github:sixears/containers-plus/r0.0.10.9";
    env-plus.url        = "github:sixears/env-plus/r1.0.7.8";

    exited.url          = "github:sixears/exited/r1.0.4.8";
    fpath.url           = "github:sixears/fpath/r1.3.2.8";
    fstat.url           = "github:sixears/fstat/r1.0.2.7";
